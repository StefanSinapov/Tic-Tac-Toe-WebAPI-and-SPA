        ...
        private void ChangeGameState(GameResult gameResult, Game game)
        {
            switch (gameResult)
            {
                case GameResult.WonByX:
                    ...
                    this.Data.Users.Find(game.FirstPlayerId).Wins++;
                    this.Data.Users.Find(game.SecondPlayerId).Losses++;
                    break;
                case GameResult.WonByY:
                    game.State = GameState.GameWonByO;
                    this.Data.Users.Find(game.SecondPlayerId).Wins++;
                    this.Data.Users.Find(game.FirstPlayerId).Losses++;
                    break;
